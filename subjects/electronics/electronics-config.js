...
window.QUIZ_CONFIG = {
  ...
  milestoneMsgs: {
    1:  { e:'⚡', b:'linear-gradient(135deg,#f59e0b,#ef4444)', t:['第一题拿下！电路开始导通了！','电流已通！知识回路激活！']},
    3:  { e:'💡', b:'linear-gradient(135deg,#10b981,#059669)', t:['三连对！灯泡亮了！','三连！基尔霍夫为你鼓掌！']},
    5:  { e:'🔌', b:'linear-gradient(135deg,#6366f1,#8b5cf6)', t:['五连对！电路全通！','五连！欧姆定律在你手中！']},
    10: { e:'🔋', b:'linear-gradient(135deg,#ec4899,#f43f5e)', t:['十连对！电池满电！','十连！你就是行走的万用表！']},
    20: { e:'💥', b:'linear-gradient(135deg,#f97316,#ef4444)', t:['二十连对！电爆了！','二十连！你已超越基尔霍夫本人！']}
  }
};
